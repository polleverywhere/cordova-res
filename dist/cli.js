...
function parseassetSuffix(args) {
    return cli_1.getOptionValue(args, '--asset-suffix', exports.DEFAULT_ASSET_SUFFIX);
}
exports.parseassetSuffix = parseassetSuffix;
