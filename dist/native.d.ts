...
export declare function copyToNativeProject(platform: Platform, nativeProject: NativeProjectConfig, resourcesDirectory: string, shouldCopyIcons: boolean, shouldCopySplash: boolean, assetSuffix: string, logstream: NodeJS.WritableStream | null, errstream: NodeJS.WritableStream | null): Promise<void>;
